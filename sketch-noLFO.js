...
//Dr. Stephen Roddy, Sebastian Adams, and Aidan Reilly


const filter = new Tone.Filter(440, "lowpass").toDestination(); //make lopass, connect to output
const minCutoff = 250;
...
if (mouseIsPressed || touches.length > 0) {
  ...
  fill(255);
  text('one sine wave on each axis', width / 2, height - 60);
...
let osc2Freq = map(y, 0, height, 440, 660); //mouseY
...
//print freqs to console
console.log("oscFreq (X-axis):", oscFreq, "osc2Freq (Y-axis):", osc2Freq, "Cutoff:", cutoff);
}
